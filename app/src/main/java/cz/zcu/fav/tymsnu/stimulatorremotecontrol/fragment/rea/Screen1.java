...
import cz.zcu.fav.tymsnu.stimulatorremotecontrol.adapter.REAScreen1ListViewPager;
...
import cz.zcu.fav.tymsnu.stimulatorremotecontrol.model.handler.packet.REAPacketHandler;
...
public class Screen1 extends AScreen 
    ...
    public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
        ConfigurationREA selected = (ConfigurationREA) listView.getItemAtPosition(position);
        ...
        ((REAScreen1ListViewPager) listView.getAdapter()).notifyDataSetChanged();
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        final ConfigurationREA configuration = manager.itemList.get(listPosition);
            ...
            case R.id.context_duplicate:
                showInputDialog(new DialogCallback() {
                    ...
                    public void callback(String res) {
                        try {
                            ConfigurationREA duplicated = manager.duplicate(configuration, res);
    ...
    private ArrayAdapter<ConfigurationREA> buildAdapter() {
        return new REAScreen1ListViewPager(getContext(), manager.itemList);
    }
    ...
    private final class PlayConfigurationListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (configuration == null)
                ...
                List<Packet> packets = new REAPacketHandler(configuration).getPackets();

...
public class REAScreen1ListViewPager extends ArrayAdapter<ConfigurationREA> {

    private final Context context;
    private final List<ConfigurationREA> objects;

    public REAScreen1ListViewPager(Context context, List<ConfigurationREA> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ConfigurationREA configuration = objects.get(position);

...
public final class Codes {
    ...
    public static final Code RANDOMNESS_ON = new Code((byte) 0x04, "RANDOMNESS_ON");
    ...
    public static final Code OUTPUT67_BRIGHTNESS = new Code((byte) 0x39, "OUTPUT67_BRIGHTNESS"); //TODO nejasný kód
    ...
    public static final Code OUTPUT45_BRIGHTNESS = new Code((byte) 0x38, "OUTPUT45_BRIGHTNESS", OUTPUT67_BRIGHTNESS); //TODO nejasný kód
    ...
    public static final Code OUTPUT3_BRIGHTNESS = new Code((byte) 0x1F, "OUTPUT3_BRIGHTNESS", OUTPUT45_BRIGHTNESS);

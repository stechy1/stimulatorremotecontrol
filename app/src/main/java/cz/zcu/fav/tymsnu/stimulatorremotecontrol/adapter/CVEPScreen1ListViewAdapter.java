...
public class CVEPScreen1ListViewAdapter extends ArrayAdapter<ConfigurationCVEP> {

    private final Context context;
    private final List<ConfigurationCVEP> objects;

    public CVEPScreen1ListViewAdapter(Context context, List<ConfigurationCVEP> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ConfigurationCVEP configuration = objects.get(position);

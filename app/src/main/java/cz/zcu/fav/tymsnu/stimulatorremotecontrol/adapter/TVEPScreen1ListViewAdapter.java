...
public class TVEPScreen1ListViewAdapter  extends ArrayAdapter<ConfigurationTVEP> {

    private final Context context;
    private final List<ConfigurationTVEP> objects;

    public TVEPScreen1ListViewAdapter(Context context, List<ConfigurationTVEP> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ConfigurationTVEP configuration = objects.get(position);
